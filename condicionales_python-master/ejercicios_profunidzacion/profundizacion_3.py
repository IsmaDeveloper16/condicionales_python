...
respuesta_usuario1 = str(input("ingrese su respuesta: ")).lower()

print("¿Cuál es la capital de Perú?")
respuesta_usuario2 = str(input("ingrese su respuesta: ")).lower()

print("¿Cuál es la capital de Uruguay?")
respuesta_usuario3 = str(input("ingrese su respuesta: ")).lower()

print("¿Cuál es la capital de Colombia?")
respuesta_usuario4 = str(input("ingrese su respuesta: ")).lower()

print("¿Cuál es la capital de Venezuela?")
respuesta_usuario5 = str(input("ingrese su respuesta: ")).lower()


if respuesta_usuario1 == respuesta_1 :
    puntaje += 10

if respuesta_usuario2 == respuesta_2 :
    puntaje += 10

if respuesta_usuario3 == respuesta_3:
    puntaje += 10

if respuesta_usuario4 == respuesta_4:
    puntaje += 10

if respuesta_usuario5 == respuesta_5:
    puntaje += 10

print("resultados finales de la trivia tu puntaje es: ", puntaje)
