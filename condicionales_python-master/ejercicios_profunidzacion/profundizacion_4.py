...
temperatura_2 = float(input("ingrese una temperatura: "))

temperatura_3 = float(input("ingrese una temperatura: "))

temperatura_total = temperatura_1 + temperatura_2 + temperatura_3

temperatura_promedio = temperatura_total / 3

print("la suma de todas las temperaturas ingresadas es: ", temperatura_total)

print(" el promedio de todas las temperaturas es: ",temperatura_promedio)